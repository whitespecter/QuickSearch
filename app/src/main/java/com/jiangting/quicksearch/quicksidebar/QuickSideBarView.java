package com.jiangting.quicksearch.quicksidebar;
...
import com.jiangting.quicksearch.R;
...
public class QuickSideBarView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mTextColor = context.getResources().getColor(android.R.color.holo_red_dark);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mHeight = getHeight() - 2*mPaddingTop;
        mWidth = getWidth();
